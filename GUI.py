...
btn_photos=ImageTk.PhotoImage(Image.open("C:/Users/ELPRO/Documents/bitbucket/sorting_by_python/Logos/browse.png"))
#varibales
...
#Buttons
browes_path_btn=tkinter.Button(root,image=btn_photos,width=42,height=18,bd=0,relief="flat",bg="white",activebackground="#f6ff00")
browes_path_btn.place(rely=.58,relx=.83)

browes_SORTin_btn=tkinter.Button(root,image=btn_photos,width=42,height=18,bd=0,relief="flat",bg="white",activebackground="#f6ff00")
...
submit_btn=tkinter.Button(root,text="Submit",width=12,height=2,font=("Microsoft JhengHei UI Light",16,"bold")
                          ,bd=0,relief="flat",fg="#00b7ff",bg="white",activebackground="#f6ff00")
